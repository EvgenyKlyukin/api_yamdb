# Generated by Django 3.2.16 on 2025-04-02 13:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, message='Год не может быть меньше 1'), django.core.validators.MaxValueValidator(reviews.models.current_year, message='Год не может быть больше текущего')], verbose_name='Год выпуска')),
